          ...
          <div>
              ...
              <div className='linkText'>
                <div className="ui large buttons">
                  <div className="ui button">
                    <a href='https://github.com/Oura-ring-tag-visualizer/sleepVisualizer'>Github Link </a>
                  </div>
                  <div className="or"></div>
                  <div className="ui button">
                    <a href='https://sleepvisualizer.herokuapp.com/'>Deployed Link </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='ui grey inverted segment'>
              ...
              <div className='linkText'>
                <div className="ui large buttons">
                  <div className="ui button">
                    <a href='https://github.com/Team-gs-Naruto/Grace-Shopper'>Github Link </a>
                  </div>
                  <div className="or"></div>
                  <div className="ui button">
                    <a href='sneakershopper.herokuapp.com'>Deployed Link </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='ui grey inverted segment'>
              ...
              <div className='linkText'>
                <div className="ui large buttons">
                  <div className="ui button">
                    <a href='https://github.com/2004-fsa-team-jiraiya/Gammiee'>Github Link </a>
                  </div>
                  <div className="or"></div>
                  <div className="ui button">
                    <a href='https://demon-dash.herokuapp.com'>Deployed Link </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='ui grey inverted segment'>
              ...
              <div className='linkText'>
                <div className="ui large buttons">
                  <div className="ui button">
                    <a href='https://github.com/SohamDutta1216/theShoppies'>Github Link </a>
                  </div>
                  <div className="or"></div>
                  <div className="ui button">
                    <a href='https://theshoppies-2021.netlify.app/'>Deployed Link </a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='ui grey inverted segment'>
              ...
              <div className='linkText'>
                <div className="ui large buttons">
                  <div className="ui button">
                    <a href='https://github.com/SohamDutta1216/tandemApprentice'>Github Link </a>
                  </div>
                  <div className="or"></div>
                  <div className="ui button">
                    <a href='https://theshoppies-2021.netlify.app/'>Deployed Link </a>
